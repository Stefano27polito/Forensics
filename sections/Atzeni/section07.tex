...
In the context of a "sound and admissible" investigation, Prof. Atzeni highlights the critical transition from high-level OS metaphors to low-level hardware interaction.

\subsection{The File System and Mounting Risks}
OS provides a simplified interface to interact with storage  (files and folders), this abstraction presents specific forensic risks during the \textbf{mounting} process:
\begin{itemize}
...
Under Unix-derived systems, hardware is abstracted as files within the \texttt{/dev} directory. Prof. Atzeni classifies these into several categories:
