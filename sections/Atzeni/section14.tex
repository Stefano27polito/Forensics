...
\begin{itemize}
    \item \textbf{Adversarial Robustness Flaws:} Attcakers can evade detection by altering file extensions, embedding steganographic data, or using adversarial perturbations specifically designed to trick AI classifiers.
...
\subsubsection*{2. Repeatability vs. Probabilistic}
...
\begin{itemize}
    \item \textbf{Probabilistic Problem:} Since LLMs run on probabilistic predictions, entering the exact same prompt twice through a pipeline can yield two different execution paths, text summaries, or script outputs.
