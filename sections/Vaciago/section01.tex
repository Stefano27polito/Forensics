...
\subsubsection{Evidence Created by Both Humans and Computer}
...
\begin{quotation}
  \textbf{Author's note:} \textit{ Professor Vaciago underlines that the goal is not to memorize a specific standard, but to recognize the principal steps involved. (as I already said about Atzeni}
\end{quotation}
