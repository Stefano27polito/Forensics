...
\begin{quotation}
    ...
    In addition, every topics that Dal Checco covered, we arleady discussed them in this note
\end{quotation}
...
\begin{itemize}
    \item \textbf{Usage:} Analyzing massive amounts of public data.
...
\begin{itemize}
    \item \textbf{"Save" Mistake:} In an attempt to "protect" the suspect's university thesis, officers opened the file and saved it. This action altered the \textbf{Last Access} and \textbf{Last Modified} timestamps, destroying critical metadata needed to verify the digital alibi.
...
\subsubsection{Digital Archaeology}
