...
\begin{quotation}
    \textbf{Author's note:} I did't understand if this chapter is part of the exam. By the way, this lesson is focused on the interaction between Paolo Dal Checco (Digital Forensic Expert) and Prof. Vaciago
\end{quotation}
...
\subsection{Consolidated List of Forensic Errors (The 10 Points)}
...
\hline
\textbf{\#} & \textbf{Description of Forensic/Procedural Error} \\
\hline
